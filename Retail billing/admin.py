...
class login_page:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("Retail Manager(ADMIN) Project By- Ashuttosh & Anuskha")
...
class Admin_Page:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("ADMIN Mode  Project By- Ashuttosh & Anuskha ")
...
class Inventory:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Inventory Project By- Ashuttosh & Anuskha ")
...
class add_product:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Add Product Project By- Ashuttosh & Anuskha ")
...
class Employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Employee Management Project By- Ashuttosh & Anuskha ")
...
class add_employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Add Employee Project By- Ashuttosh & Anuskha ")
...
class Update_Employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Update Employee Project By- Ashuttosh & Anuskha ")
...
class Invoice:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Invoices Project By- Ashuttosh & Anuskha ")
...
class open_bill:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("Bill Project By- Ashuttosh & Anuskha ")
